...
- [x] The exact DSH runtime is pinned to `@deepseek-ai/dsh@0.1.2-rc.1`; the checked lock contains 583 integrity-pinned package entries and the deployment uses Node 24.19.0.
