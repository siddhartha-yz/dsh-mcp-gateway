...
class ArchitectureContractTests(unittest.TestCase):
    ...
    def test_dsh_bridge_uses_native_tool_runtime_seam(self) -> None:
        ...
        self.assertIn('"http://127.0.0.1/*"', observer_manifest)
        self.assertIn('"http://localhost/*"', observer_manifest)
        self.assertNotIn('"http://127.0.0.1:3080/*"', observer_manifest)
        self.assertNotIn('"http://localhost:3080/*"', observer_manifest)
